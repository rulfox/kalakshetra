...
function Footer() {
  return /*#__PURE__*/React.createElement("footer", {
    ...
    title: "Reach us",
    links: [{text:'WhatsApp · 8547516011',href:'https://wa.me/918547516011',external:true},{text:'Call · 8547516011',href:'tel:+918547516011'},{text:'@kalakshetra_handpaintings',href:'https://www.instagram.com/kalakshetra_handpaintings/',external:true,icon:'instagram'}]
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
...
function FooterCol({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    const icon = typeof l === 'object' && l.icon;
    return /*#__PURE__*/React.createElement("a", Object.assign({
      key: txt, href: href,
      style: {fontFamily:'var(--font-body)',fontSize:'var(--fs-sm)',color:'var(--on-dark-soft)',textDecoration:'none',display:'flex',alignItems:'center',gap:'0.4em'}
    }, ext ? {target:'_blank',rel:'noopener noreferrer'} : {}),
      icon === 'instagram' && /*#__PURE__*/React.createElement("svg", {
        xmlns:"http://www.w3.org/2000/svg",width:13,height:13,viewBox:"0 0 24 24",
        fill:"currentColor","aria-hidden":"true",style:{flexShrink:0}
